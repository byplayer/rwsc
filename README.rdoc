...
2.  Require the gem (You may need to also require rubygems, depending on your setup):
require 'rubygems'
require 'rwsc'

3.  Use the gem to make a call to the API:
...
But feel free to get in touch with evanburchard if you have any questions.


**And yes, those are 24 other APIs to the left, just waiting to be implemented! 
